...
void loop() 
{
  ...
  if (millis() - loopTimer > 1000)
  {
    ...
    bt.println(y);
    bt.println(z);
    bt.println(xl.convertToG(100,x)); // The convertToG() function
    bt.println(xl.convertToG(100,y)); // accepts as parameters the
    bt.println(xl.convertToG(100,z)); // raw value and the current
    bt.println(" ");                // maximum g-rating.
  }
